...
citadel_paints = pd.read_csv(
    "paints/citadel_paints.csv", header=None, names=["Paint_Name", "Type", "Hex"]
)
...
citadel_paints["RGB"] = citadel_paints["Hex"].apply(
    lambda x: ImageColor.getcolor(x, "RGB")
)
